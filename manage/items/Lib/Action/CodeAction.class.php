...
class CodeAction extends Action {
    ...
    public function index()
    {
		...
		$this->display(A('Impot')->model($this->group['guid']).'/Code/index');
    }
    ...
    */
    ...
    {
		$this->group = A('Impot')->IssetGroup($_GET['groupid']);
		$this->display(A('Impot')->model($this->group['guid']).'/Code/add');
    }
    ...
    */
    public function edit()
    {
		...
		$this->display(A('Impot')->model($this->group['guid']).'/Code/edit');
    }

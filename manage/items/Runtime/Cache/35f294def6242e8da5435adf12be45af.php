            ...
            <table>
              ...
              <tbody role="alert" aria-live="polite" aria-relevant="all">
                <?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$value): $mod = ($i % 2 );++$i;?><tr align="center">
                    ...
                    <td><?php echo ($value["entitle"]); ?></td>
                    <td><?php if($value['status'] == 0): ?>否<?php else: ?><font style="color:#f00;">是</font><?php endif; ?></td>
                    <td style="text-align:center;"><?php echo M('pro')->where('pid="'.$value['guid'].'"')->count();?></td>
                    <?php $count = M('prodir')->where('pid="'.$value['guid'].'"')->count();?>
                    <td style="text-align:center;"><a class="hrefa" href="__URL__/edit/guid/<?php echo ($value["guid"]); ?>">修改</a>  <?php if($count != 0): ?><a class="hrefa" href="__URL__/index/pid/<?php echo ($value["guid"]); ?>">子系列</a><?php endif; ?> <a class="hrefa" href="__APP__/Pro/index/pid/<?php echo ($value["guid"]); ?>">管理产品</a></td>
                  </tr><?php endforeach; endif; else: echo "" ;endif; ?>
              </tbody>
            </table>
            <div class="ui-widget-header">
              <div class="dataTables_filter">
              <?php if($pid == '0'): ?><a href="__URL__/add/groupid/<?php echo ($group["guid"]); ?>">添加系列</a><?php else: endif; ?>

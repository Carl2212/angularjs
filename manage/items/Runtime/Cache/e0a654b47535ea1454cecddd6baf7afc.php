        ...
        <form action="__URL__/submit_edit" name="form" method="post" enctype="application/x-www-form-urlencoded" class="form-horizontal">
          <div class="widget-content nopadding">
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" size="200" placeholder="标题" name="title" value="<?php echo ($dir["title"]); ?>">
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input name="locked" type="radio" value="0" <?php if($dir['locked'] == '0'): ?>checked="checked"<?php endif; ?>>否
                <input name="locked" type="radio" value="1" <?php if($dir['locked'] == '1'): ?>checked="checked"<?php endif; ?>>是
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">能否添加子栏目:</label>
              <div class="controls">
                <input name="isadd" type="radio" value="0" <?php if($dir['isadd'] == '0'): ?>checked="checked"<?php endif; ?>>能
                <input name="isadd" type="radio" value="1" <?php if($dir['isadd'] == '1'): ?>checked="checked"<?php endif; ?>>不能
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">能否添加内容:</label>
              <div class="controls">
                <input name="isaddc" type="radio" value="0" <?php if($dir['isaddc'] == '0'): ?>checked="checked"<?php endif; ?>>能
                <input name="isaddc" type="radio" value="1" <?php if($dir['isaddc'] == '1'): ?>checked="checked"<?php endif; ?>>不能
              </div>
            </div>
            <div class="control-group">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <select name="mid" class="span11">
                  <?php if(is_array($model)): $i = 0; $__LIST__ = $model;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$value): $mod = ($i % 2 );++$i;?><option value="<?php echo ($value["guid"]); ?>" 
                    <?php if($dir["mid"] == $value["guid"]): ?>selected="selected"<?php endif; ?>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" id="oneimg_value" value="<?php echo ($dir["oneimg"]); ?>" size="70" name="oneimg">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" size="200" name="summary" value="<?php echo ($dir["summary"]); ?>">
              </div>
            </div> 
            <div class="form-actions">
              <input type="hidden" name="guid" value="<?php echo ($dir["guid"]); ?>">

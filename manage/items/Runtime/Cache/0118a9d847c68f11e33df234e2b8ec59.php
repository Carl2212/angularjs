        ...
        <form action="__URL__/submit_edit" name="form" method="post" enctype="application/x-www-form-urlencoded" class="form-horizontal">
          <div class="widget-content nopadding">
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" size="100" name="title" placeholder="产品名称" value="<?php echo ($diyimg["title"]); ?>">
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">换装图:</label>
              <div class="controls">
                <input type="text" class="span11" id="oneimg_value" value="<?php echo ($diyimg["oneimg"]); ?>" size="70" name="oneimg">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" id="twoimg_value" value="<?php echo ($diyimg["twoimg"]); ?>" size="70" name="twoimg">
            ...
            <div class="control-group">
              <label class="control-label">软装:</label>
              <div class="controls">
                <input type="text" class="span11" id="threeimg_value" value="<?php echo ($diyimg["threeimg"]); ?>" size="70" name="threeimg">
                ...
                <input type="button" name="submit" class="btn btn-success" value=" 上传 " onclick="return ajaxFileUpload('__APP__/Index/upload/name/threeimg/file/threeimg_upload/groupid/<?php echo ($group["guid"]); ?>','threeimg','threeimg_upload');">
              </div>
            </div>
            <div class="control-group" id="controls">
              <label class="control-label">坐标:</label>
              <div class="controls">
                <input  name="coordinate" type="text" class="span11" id="coordinate" placeholder="坐标" value="<?php echo ($diyimg["coordinate"]); ?>" size="20">
              </div>
            </div>
            <div class="form-actions">
            <input type="hidden" name="guid" value="<?php echo ($diyimg["guid"]); ?>">

        ...
        <form action="__URL__/submit_edit" name="form" method="post" enctype="application/x-www-form-urlencoded" class="form-horizontal">
          <div class="widget-content nopadding">
            <div class="control-group">
              ...
              <div class="controls">
                <input name="username" type="text" value="<?php echo ($code["username"]); ?>"  class="span11"  size="40" maxlength="12" onblur="this.value=this.value.replace(/[\W]/g,'')"/>
                <span class="help-block" style="color:#f00;">(注:请输入个5-12位字母或数字!)</span> </div>
            </div>
            <div class="control-group">
              <label class="control-label">密码:</label>
              <div class="controls">
                <input type="text" name="password" value="<?php echo ($code["password"]); ?>" class="span11" size="40" maxlength="15" onblur="this.value=this.value.replace(/[\W]/g,'')"/>
                <span class="help-block" style="color:#f00;">密码只能输入6-15个字母或数字</span> </div>
            </div>
            <div class="control-group">
              <label class="control-label">姓名:</label>
              <div class="controls">
                <input name="nickname" type="text" value="<?php echo ($code["nickname"]); ?>"  class="span11"  size="40" maxlength="12" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">电话:</label>
              <div class="controls">
                <input name="phone" type="text" value="<?php echo ($code["phone"]); ?>"  class="span11"  size="40" maxlength="12" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">地区:</label>
              <div class="controls">
                <input name="address" type="text" value="<?php echo ($code["address"]); ?>"  class="span11"  size="40" maxlength="12" />
              </div>
            </div>
            <div class="form-actions">
              <input type="hidden" name="guid" value="<?php echo ($code["guid"]); ?>">

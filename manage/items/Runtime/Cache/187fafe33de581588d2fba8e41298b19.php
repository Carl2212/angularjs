        ...
        <div class="widget-box">
          <div class="widget-content">
            <table>
              ...
              <tbody role="alert" aria-live="polite" aria-relevant="all">
                <?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$value): $mod = ($i % 2 );++$i;?><tr align="center">
                    ...
                    <td><a class="hrefa" href="__URL__/edit/guid/<?php echo ($value["guid"]); ?>">修改</a>
                     </td>
            ...
            <div class="ui-widget-header">
              ...
              <span>栏目:</span>
              <select name="pid"><?php echo ($dirlist); ?></select>
              <input type="button" value="移动" name="delete" onclick="if(getSelect(this.form) && confirm('确实要移动吗?')){this.form.action='__URL__/move';this.form.submit();}" class="btn">
              <a href="__URL__/add/pid/<?php echo ($dir["guid"]); ?>">添加</a>

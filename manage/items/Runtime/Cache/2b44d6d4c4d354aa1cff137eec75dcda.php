        ...
        <form action="__URL__/submit_edit" name="form" method="post" enctype="application/x-www-form-urlencoded" class="form-horizontal">
          <div class="widget-content nopadding">
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" size="100" name="title" placeholder="产品名称" value="<?php echo ($diyimgpro["title"]); ?>">
                <span class="help-block" style="color:#f00;">请与产品的名称保持一致,否则不能正常显示</span> 
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">换装图:</label>
              <div class="controls">
                <input type="text" class="span11" id="oneimg_value" value="<?php echo ($diyimgpro["oneimg"]); ?>" size="70" name="oneimg">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" size="100" name="size" placeholder="附加产品尺寸" value="<?php echo ($diyimgpro["size"]); ?>">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" id="twoimg_value" value="<?php echo ($diyimgpro["twoimg"]); ?>" size="70" name="twoimg">
            ...
            <input type="hidden" name="guid" value="<?php echo ($diyimgpro["guid"]); ?>">

        ...
        <form action="__URL__/submit_edit" name="form" method="post" enctype="application/x-www-form-urlencoded" class="form-horizontal">
          <div class="widget-content nopadding">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" id="file_value" value="<?php echo ($content["file"]); ?>" size="70" name="file">
                <input id="file_upload" type="file" class="span11" size="30" name="file_upload">
                <input type="button" name="submit" class="btn btn-success" value=" 上传 " onclick="return ajaxFileUpload('__APP__/Index/upload/name/file/file/file_upload/groupid/<?php echo ($group["guid"]); ?>','file','file_upload');">
              </div>
            </div>

        ...
        <form action="__URL__/submit_edit" name="form" method="post" enctype="application/x-www-form-urlencoded" class="form-horizontal">
          <div class="widget-content nopadding">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" size="100" name="price" placeholder="价格" value="<?php echo ($pro["price"]); ?>">
              </div>
            </div>
            <div class="control-group">
              ...
              <div class="controls">
                <select name="protypeid" class="span11">
                  ...
                  <?php if(is_array($protype)): $i = 0; $__LIST__ = $protype;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$value): $mod = ($i % 2 );++$i;?><option value="<?php echo ($value["guid"]); ?>" <?php if($pro['protypeid'] == $value['guid']): ?>selected="selected"<?php endif; ?>><?php echo ($value["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
              </div>
            </div>
            <div class="control-group">

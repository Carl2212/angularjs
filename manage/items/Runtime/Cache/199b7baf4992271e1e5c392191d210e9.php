        ...
        <form action="__URL__/submit_edit" name="form" method="post" enctype="application/x-www-form-urlencoded" class="form-horizontal">
          <div class="widget-content nopadding">
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" size="100" name="title" placeholder="" value="<?php echo ($pro["title"]); ?>">
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">防盗等级:</label>
              <div class="controls">
                <input type="text" class="span11" size="100" name="level" value="<?php echo ($pro["level"]); ?>">
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">标准规格:</label>
              <div class="controls">
                <input type="text" class="span11" size="100" name="bzgg" value="<?php echo ($pro["bzgg"]); ?>">
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">门扇厚度:</label>
              <div class="controls">
                <input type="text" class="span11" size="100" name="mshd" value="<?php echo ($pro["mshd"]); ?>">
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">门框料度:</label>
              <div class="controls">
                <input type="text" class="span11" size="100" name="mkld" value="<?php echo ($pro["mkld"]); ?>">
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">门扇料度:</label>
              <div class="controls">
                <input type="text" class="span11" size="100" name="msld" value="<?php echo ($pro["msld"]); ?>">
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">铰链:</label>
              <div class="controls">
                <input type="text" class="span11" size="100" name="jiaolian" value="<?php echo ($pro["jiaolian"]); ?>">
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">锁具:</label>
              <div class="controls">
                <input type="text" class="span11" size="100" name="suoju" value="<?php echo ($pro["suoju"]); ?>">
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">锁芯:</label>
              <div class="controls">
                <input type="text" class="span11" size="100" name="suoxin" value="<?php echo ($pro["suoxin"]); ?>">
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">拉手:</label>
              <div class="controls">
                <input type="text" class="span11" size="100" name="lashou" value="<?php echo ($pro["lashou"]); ?>">
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">门面工艺:</label>
              <div class="controls">
                <input type="text" class="span11" size="100" name="mmgy" value="<?php echo ($pro["mmgy"]); ?>">
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">门面款式:</label>
              <div class="controls">
                <input type="text" class="span11" size="100" name="mmks" value="<?php echo ($pro["mmks"]); ?>">
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">填充物:</label>
              <div class="controls">
                <input type="text" class="span11" size="100" name="tcw" value="<?php echo ($pro["tcw"]); ?>">
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">门镜:</label>
              <div class="controls">
                <input type="text" class="span11" size="100" name="menjing" value="<?php echo ($pro["menjing"]); ?>">
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">密封条:</label>
              <div class="controls">
                <input type="text" class="span11" size="100" name="mft" value="<?php echo ($pro["mft"]); ?>">
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">备注:</label>
              <div class="controls">
                <textarea class="span11" rows="5" cols="100" name="remarks"><?php echo ($pro["remarks"]); ?></textarea>
              </div>
            </div>
            <div class="control-group">

...
<div id="content">
  ...
  <div id="breadcrumb"> <a href="__APP__/Index/index/groupid/<?php echo ($group["guid"]); ?>"><i class="icon-home"></i><?php echo ($group["title"]); ?></a> <a href="__URL__/index/groupid/<?php echo ($group["guid"]); ?>" class="current">内容模版</a> </div>
        ...
        <form action="__URL__/submit_edit" name="form" method="post" enctype="application/x-www-form-urlencoded" class="form-horizontal">
          <div class="widget-content nopadding">
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" size="100" name="title" placeholder="模版名称" value="<?php echo ($model["title"]); ?>">
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">显示模版:</label>
              <div class="controls">
                <select name="show_model" class="span11"><?php echo ($show_model); ?></select>
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">添加模版:</label>
              <div class="controls">
                <select name="add_model" class="span11"><?php echo ($add_model); ?></select>
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">修改模版:</label>
              <div class="controls">
                <select name="edit_model" class="span11"><?php echo ($edit_model); ?></select>
              </div>
            </div>

        ...
        <form action="__URL__/submit_add" name="form" method="post" enctype="application/x-www-form-urlencoded" class="form-horizontal">
          <div class="widget-content nopadding">
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" size="100" name="title" placeholder="">
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">防盗等级:</label>
              <div class="controls">
                <input type="text" class="span11" size="100" name="level">
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">标准规格:</label>
              <div class="controls">
                <input type="text" class="span11" size="100" name="bzgg">
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">门扇厚度:</label>
              <div class="controls">
                <input type="text" class="span11" size="100" name="mshd">
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">门框料度:</label>
              <div class="controls">
                <input type="text" class="span11" size="100" name="mkld">
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">门扇料度:</label>
              <div class="controls">
                <input type="text" class="span11" size="100" name="msld">
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">铰链:</label>
              <div class="controls">
                <input type="text" class="span11" size="100" name="jiaolian">
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">锁具:</label>
              <div class="controls">
                <input type="text" class="span11" size="100" name="suoju">
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">锁芯:</label>
              <div class="controls">
                <input type="text" class="span11" size="100" name="suoxin">
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">拉手:</label>
              <div class="controls">
                <input type="text" class="span11" size="100" name="lashou">
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">门面工艺:</label>
              <div class="controls">
                <input type="text" class="span11" size="100" name="mmgy">
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">门面款式:</label>
              <div class="controls">
                <input type="text" class="span11" size="100" name="mmks">
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">填充物:</label>
              <div class="controls">
                <input type="text" class="span11" size="100" name="tcw">
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">门镜:</label>
              <div class="controls">
                <input type="text" class="span11" size="100" name="menjing">
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">密封条:</label>
              <div class="controls">
                <input type="text" class="span11" size="100" name="mft">
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">备注:</label>
              <div class="controls">
                <textarea class="span11" rows="5" cols="100" name="remarks"></textarea>
              </div>
            </div>
            <div class="control-group">

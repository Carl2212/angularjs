            ...
            <table>
              ...
              <tbody role="alert" aria-live="polite" aria-relevant="all">
                <?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$value): $mod = ($i % 2 );++$i;?><tr align="center">
                    ...
                    <td><?php echo ($value["show_model"]); ?></td>
                    <td><?php echo ($value["add_model"]); ?></td>
                    <td><?php echo ($value["edit_model"]); ?></td>
                    <td style="text-align:center;"><a class="hrefa" href="__URL__/edit/id/<?php echo ($value["guid"]); ?>">修改</a></td>

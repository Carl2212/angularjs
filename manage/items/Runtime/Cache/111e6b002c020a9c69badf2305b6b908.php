        ...
        <div class="widget-box">
          <div class="widget-content">
            <table>
              ...
              <tbody role="alert" aria-live="polite" aria-relevant="all">
                <?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$value): $mod = ($i % 2 );++$i;?><tr align="center">
                    ...
                    <td style="text-align:center;"><a class="hrefa" href="__URL__/edit/guid/<?php echo ($value["guid"]); ?>">修改</a>
                    <?php $count = M('diyimgtype')->where('diyimgid="'.$value['guid'].'"')->count();?>
                    <?php if($count != 0): if($focus['type'] != 5): ?><a class="hrefa" href="__APP__/Diyimgtype/index/diyimgid/<?php echo ($value["guid"]); ?>">关联色板</a>
                    <?php else: ?>
                    <a class="hrefa" href="__APP__/Diyimgtype/index/diyimgid/<?php echo ($value["guid"]); ?>">关联系列</a><?php endif; endif; ?>
                    </td>
            ...
            <div class="ui-widget-header">
              ...
              <?php if($focus['type'] != 5): ?><a href="__URL__/add/focusid/<?php echo ($focus["guid"]); ?>">添加</a>
              ...
              <input type="button" value="彻底删除" name="delete" onclick="if(getSelect(this.form) && confirm('确实要删除吗?')){this.form.action='__URL__/delete';this.form.submit();}" class="btn"><?php endif; ?>
              </div>

        ...
        <form action="__URL__/submit_edit" name="form" method="post" enctype="application/x-www-form-urlencoded" class="form-horizontal">
          <div class="widget-content nopadding">
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" size="100" name="title" placeholder="标题" value="<?php echo ($focus["title"]); ?>">
              </div>
            </div>
            <div class="control-group">
              ...
              <option value="0" <?php if($focus['type'] == 0): ?>selected="selected"<?php endif; ?>>场景</option>
              <option value="1" <?php if($focus['type'] == 1): ?>selected="selected"<?php endif; ?>>门花</option>
              <option value="2" <?php if($focus['type'] == 2): ?>selected="selected"<?php endif; ?>>色板</option>
              <option value="3" <?php if($focus['type'] == 3): ?>selected="selected"<?php endif; ?>>锁具</option>
              <option value="4" <?php if($focus['type'] == 4): ?>selected="selected"<?php endif; ?>>压线</option>
              <option value="5" <?php if($focus['type'] == 5): ?>selected="selected"<?php endif; ?>>颜色</option>
              </volist>
              </select>
              </div>
            </div>
            <div class="form-actions">
              <input type="hidden" name="guid" value="<?php echo ($focus["guid"]); ?>">

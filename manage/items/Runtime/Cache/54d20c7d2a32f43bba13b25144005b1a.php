...
<div id="content">
  ...
  <div id="breadcrumb"> <a href="__APP__/Index/index/groupid/<?php echo ($group["guid"]); ?>"><i class="icon-home"></i><?php echo ($group["title"]); ?></a> <a href="__URL__/index/groupid/<?php echo ($group["guid"]); ?>" class="current">DIY空间</a> 
  </div>
            ...
            <table>
              ...
              <tbody role="alert" aria-live="polite" aria-relevant="all">
                <?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$value): $mod = ($i % 2 );++$i;?><tr align="center">
                    ...
                    <td style="text-align:center;"><?php echo M('focus')->where('diyid="'.$value['guid'].'"')->count();?></td>
                    <td style="text-align:center;"><a class="hrefa" href="__URL__/edit/guid/<?php echo ($value["guid"]); ?>">修改</a> <a class="hrefa" href="__APP__/Focus/index/diyid/<?php echo ($value["guid"]); ?>/">添加diy项</a></td>
                  </tr><?php endforeach; endif; else: echo "" ;endif; ?>
              </tbody>
            </table>
            <div class="ui-widget-header">
              <div class="dataTables_filter"> <a href="__URL__/add/groupid/<?php echo ($group["guid"]); ?>">添加场景</a>

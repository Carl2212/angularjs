...
<div id="content">
  ...
  <div id="breadcrumb"> <a href="__APP__/Index/index/groupid/<?php echo ($group["guid"]); ?>"><i class="icon-home"></i><?php echo ($group["title"]); ?></a> <a href="__APP__/Diy/index/groupid/<?php echo ($group["guid"]); ?>" class="current">DIY空间:<?php echo ($diy["title"]); ?></a>  <a href="__APP__/Focus/index/diyid/<?php echo ($diy["guid"]); ?>/" class="current">换装区域:<?php echo ($focus["title"]); ?></a> <a href="__APP__/Diyimg/index/focusid/<?php echo ($focus["guid"]); ?>/" class="current">换装图:<?php echo ($diyimg["title"]); ?></a> <a href="__APP__/Diyimgtype/index/diyimgid/<?php echo ($diyimg["guid"]); ?>/" class="current">分组:<?php echo ($diyimgtype["title"]); ?></a> <a href="__URL__/index/diyimgid/<?php echo ($diyimg["guid"]); ?>" class="current">关联产品</a></div>
        ...
        <div class="widget-box">
          <div class="widget-content">
            ...
            <div class="ui-widget-header">
              <div class="dataTables_filter"> <a href="__URL__/add/diyimgid/<?php echo ($diyimg["guid"]); ?>/diyimgtypeid/<?php echo ($diyimgtype["guid"]); ?>">添加</a>

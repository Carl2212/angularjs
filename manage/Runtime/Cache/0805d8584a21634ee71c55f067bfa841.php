...
<div id="content">
  ...
  <div id="breadcrumb"> <a href="__APP__/Index/"><i class="icon-home"></i>项目管理</a> <a href="#" class="current">项目修改</a> </div>
        ...
        <form action="__URL__/submit_edit" name="form" method="post" enctype="application/x-www-form-urlencoded" class="form-horizontal">
          <div class="widget-content nopadding">
            <div class="control-group">
              ...
              <div class="controls">
                <input name="title" type="text" value="<?php echo ($group["title"]); ?>"  class="span11"  size="40" maxlength="12" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">模版:</label>
              <div class="controls">
                <input type="text" name="model" value="<?php echo ($group["model"]); ?>" class="span11" size="40" maxlength="20"/>
              </div>
            </div>
            <div class="form-actions">
              <input type="hidden" name="guid" value="<?php echo ($group["guid"]); ?>">

...
<div id="content">
  ...
  <div id="breadcrumb"><a href="__APP__/Group/" class="current"><i class="icon-home"></i>项目管理</a> <a href="#" class="current"><?php echo ($group["title"]); ?></a> <a href="#" class="current">验证码</a> </div>
          ...
          <div class="widget-content">
            <table>
              ...
              <tbody role="alert" aria-live="polite" aria-relevant="all">
                <?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$value): $mod = ($i % 2 );++$i;?><tr align="center">
                    ...
                    <td><?php if($value['binding'] == 0): ?>否<?php else: ?><font style="color:#f00;">是</font><?php endif; ?></td>
            ...
            <div class="ui-widget-header">
              <div class="dataTables_filter">
                ...
                <input type="button" value="解除绑定" name="unbinding" onclick="if(getSelect(this.form) && confirm('确实要锁定吗?')){this.form.action='__URL__/unbinding/';this.form.submit();}" class="btn">
